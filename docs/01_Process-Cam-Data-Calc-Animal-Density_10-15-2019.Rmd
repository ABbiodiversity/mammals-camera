...
# Spatial data
sf_nr <- st_read(paste0(abmisc,"base/spatial/ab_naturalregions.shp"), quiet = TRUE, stringsAsFactors = FALSE)
sf_ab <- st_read(paste0(abmisc,"base/spatial/ab_prov.shp"), quiet = TRUE, stringsAsFactors = FALSE)
abmi_dep <- st_read(paste0(abmisc,"base/spatial/abmi_deployments_public.shp"), quiet = TRUE, stringsAsFactors = FALSE)
