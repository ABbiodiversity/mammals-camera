...
```{r map_deployments, echo=FALSE, out.width="70%", fig.cap="ABMI Camera Deployments from 2015-2018.", fig.align="center"}
...
```{r imagesperyear, fig.cap="Number of images taken of each species from 2015-2018", fig.align="center"}
...
df_edd_final %>%
  ...
  scale_fill_manual(values = c("#008837","#a6611a")) +
  theme_light() +
  labs(x = "Vegetation Human Footprint Category",
...
df_density %>%
  ...
  ggplot(mapping = aes(x = cpue_km2, fill = common_name)) +
    ...
    labs(x = expression(Density~(individuals~per~km^2)),
         ...
         title = "Distribution in estimated density among camera deployments for 11 common species.") +
...
df_density %>%
  ...
  ggplot(mapping = aes(x = cpue_km2, fill = common_name)) +
    ...
    labs(x = expression(Density~(individuals~per~km^2)),
         y = "Number of Deployments",
         title = "Log-normal distribution of density using only presence records for 11 common species.") +
    facet_wrap(~ common_name, scales = "free") +
    theme_light() +
